...
public class GoogleMap extends Parent {
    ...
    public void setOnMapLatLngChanged(EventHandler<GMapEvent> eventHandler) {
        onMapLatLngChanged = eventHandler;
    }

    public void handle(double lat, double lng) {
        if(onMapLatLngChanged != null) {
            GMapEvent event = new GMapEvent(this, lat, lng);
    ...
    private EventHandler<GMapEvent> onMapLatLngChanged;
